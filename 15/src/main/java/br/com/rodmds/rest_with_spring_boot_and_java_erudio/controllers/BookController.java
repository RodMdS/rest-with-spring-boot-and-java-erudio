...
public class BookController {
    ...
    public BookVO createBookVO(@RequestBody BookVO book) {
    ...
    public BookVO updateBookVO(@RequestBody BookVO book) {
    ...
    public ResponseEntity<?> deleteBookVO(@PathVariable(value = "id") Long id) {
